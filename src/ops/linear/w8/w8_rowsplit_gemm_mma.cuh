...
// the two BM = 16 schedules in this tree - src/ops/linear/w8/w8_feature.cu and
// src/ops/attn_input_proj/w8/w8_dflash2_attn_input.cu - cost +16.8 % and +21.0 % of the operation.
// It is not a property of BM either: MmaR64x16C48K128A1, a BM = 64 tile, gains 3.3 % on
// [34816, 5120] and loses 1.1 % on [248320, 5120]. So the policy is set per schedule, and only
// where it has been measured across the shapes that reach it.
