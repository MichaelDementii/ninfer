...
// Same shape with a half accumulator: C and D are two f16x2 registers rather than four floats.
// c0 packs the two columns of the fragment's first row, c1 those of the row eight below, matching
// the (c0,c1) / (c2,c3) split of the f32 form above.
