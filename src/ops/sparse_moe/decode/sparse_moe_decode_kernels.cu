...
// BASEOPT-15 (6b): recompute the pre-MoE RMS-norm inside consumer prologs.
...
__global__ void sparse_moe_d3_nine_warp_kernel(
    ...
    if (prenorm_gamma == nullptr) {
        ...
        // BASEOPT-15: raw x arrives here; the norm recompute runs BEFORE the PDL wait,
...
#pragma unroll
    ...
    if (prefetch_data != nullptr) {
        // BASEOPT-8/11: fire-and-forget L2 warmup of the next consumer's weight codes,
