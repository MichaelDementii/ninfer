...
int q5_a16_conformance() {
    ...
    constexpr std::array<std::int32_t, 3> kK4096RouteStarts{2, 49, 129};
    constexpr std::array<std::int32_t, 11> kK4096RouteInteriors{1,  8,  12, 13, 16, 24,
                                                                33, 40, 47, 96, 256};
    failures += ninfer::test::linear_add::run_shape(
        "Q5_A16 LinearAdd", WeightFormat::Q5G64F16S,
        ShapeCase{2048, 4096, 977U, kK4096RouteStarts, kK4096RouteInteriors});
